...
#define CMD_ROLL (u8)0xE
#define CMD_AND (u8)0xF
#define CMD_OR (u8)0x10
#define CMD_XOR (u8)0x11
#define CMD_NOT (u8)0x12

#define CMD_LOAD (u8)0x13//
#define CMD_STORE (u8)0x14//
#define CMD_LDA (u8)0x15 //
#define CMD_STA (u8)0x16 //
#define CMD_PEEK (u8)0x17 //

#define CMD_ZGOTO (u8)0x18 //
#define CMD_ZGOTOF (u8)0x19 //
#define CMD_NGOTO (u8)0x1A //
#define CMD_NGOTOF (u8)0x1B//
#define CMD_GOTO (u8)0x1C //

#define CMD_ITOF (u8)0x1D //
#define CMD_FTOI (u8)0x1E //
